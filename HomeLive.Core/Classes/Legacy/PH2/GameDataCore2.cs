 ...
 * https://github.com/kwsch/PKHeX/blob/75ec6ca38dcd9ac50e781434e390c14d671ebae1/PKHeX.Core/PKM/HOME/GameDataCore.cs
 * GPL v3 License
...
/// </summary>
public sealed class GameDataCore2 : IHomeTrack, ISpeciesForm, ITrainerID, INature, IFatefulEncounter, IContestStats, IScaledSize, ITrainerMemories, IHandlerLanguage, IBattleVersion, IHyperTrain, IFormArgument, IFavorite,
    ...
    IRibbonSetCommon9, IRibbonSetMark9
{
    ...
    public GameDataCore2(Memory<byte> buffer)
    {
        if (buffer.Length != HomeCrypto.SIZE_2CORE)
    ...
    public ushort MarkingValue { get => ReadUInt16LittleEndian(Data[0x18..]); set => WriteUInt16LittleEndian(Data[0x18..], (ushort)value); }
    ...
    public byte HandlingTrainerGender { get => Data[0x86]; set => Data[0x86] = (byte)value; }
    public byte HandlingTrainerLanguage { get => Data[0x87]; set => Data[0x87] = value; }
    public byte CurrentHandler { get => Data[0x88]; set => Data[0x88] = (byte)value; }
    public ushort HandlingTrainerID { get => ReadUInt16LittleEndian(Data[0x89..]); set => WriteUInt16LittleEndian(Data[0x89..], (ushort)value); } // unused?
    public byte HandlingTrainerFriendship { get => Data[0x8B]; set => Data[0x8B] = (byte)value; }
    ...
    public byte Language { get => Data[0x93]; set => Data[0x93] = value; }
    ...
    public byte OriginalTrainerFriendship { get => Data[0xB3]; set => Data[0xB3] = (byte)value; }
    ...
    public byte EggYear { get => Data[0xB9]; set => Data[0xB9] = (byte)value; }
    public byte EggMonth { get => Data[0xBA]; set => Data[0xBA] = (byte)value; }
    public byte EggDay { get => Data[0xBB]; set => Data[0xBB] = (byte)value; }
    public byte MetYear { get => Data[0xBC]; set => Data[0xBC] = (byte)value; }
    public byte MetMonth { get => Data[0xBD]; set => Data[0xBD] = (byte)value; }
    public byte MetDay { get => Data[0xBE]; set => Data[0xBE] = (byte)value; }
    public byte MetLevel { get => Data[0xBF]; set => Data[0xBF] = (byte)value; }
    public byte OriginalTrainerGender { get => Data[0xC0]; set => Data[0xC0] = (byte)value; }
